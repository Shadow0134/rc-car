...
- Raspberry Pi 5
- Pi Camera Module 3
- External 4G Adapter for connectivity 
- gocryptfs Secure Storage
- Arduino Pro Micro (Rubber Ducky payload system, coz the original once weren't available in our region 😢)
- A RC Car 
